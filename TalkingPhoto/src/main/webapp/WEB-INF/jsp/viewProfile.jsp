...
<nav class="navbar navbar-light bg-light">
  ...
  <c:out value="${userObj.name }"></c:out>
...
<nav class="nav nav-pills nav-justified">
  <a class="nav-item nav-link active" href="/viewProfile">View My Profile</a>
...
<!-- This part render post that user clicked on from  his profile : start -->
...
<!-- This part render post that user clicked on from  his profile : end -->
...
<div class="row-fluid" style="clear:  left;border:2px solid black">
	...
	<div class="col-md-6" style="float:left;height: 50px;width: 500px;margin-left: 30px; border:2px solid blue">
		<p>Name : <c:out value="${userVar.name }"> : name :</c:out></p>	
		<p>Description : <c:out value="${userVar.description }"></c:out></p>
	</div>
	<div class="col-md-2" style="float:left;">
		<form action="/editProfile" method="post">
		<input type="hidden" name="editProfileUser" value="${userVar.fbIDUser}">
			<input type="submit" value="Edit Profile">
		</form>
	</div>
</div>
</c:if>
<!-- This part render profile info only if user clicks on friend to see his profile : end -->
</div>
...
<!-- This part render post only if user clicks on friend to see his profile : end -->
</body>
<script>
function viewPost(id){
	$('[name="postIdForViewPost"]').val(id);
	$('[name="comingFromScreenName"]').val('viewProfile');
	$('#viewPostForm').submit();
}
</script>
</html>